...
const Hero = () => {
  return (
    <section className='w-full items-center justify-items-center'>
    <div className='w-full h-[90vh] top-[90px] items-center justify-items-center'>
      <video
        className='object-cover h-full w-[90%] absolute -z-10'
        src={heroVid}
        autoPlay
        loop
        muted
